class StatsController < ApplicationController
  ...
  def rooms
    ...
    @rooms = StatsService.top_rooms_by_message_count(100)

    @top_talkers = {}
    @rooms.each do |room|
      top_talkers = StatsService.room_top_talkers(room, 1)
      @top_talkers[room.id] = top_talkers.first if top_talkers.any?
    end
